...
class Frontend():
    def __init__(self, lugar):
        ...
        self.google = str(f"https://www.google.com/search?q=previsao+climatempo+{self.sufixo}")
    ...
    def _titulacao(self, lista_links):
        ...
        for link in lista_links:
            ...
            if (pagina.status_code == 200) and (pagina.ok == True):
                ...
                tagTitulo = str(html.title.text)
                if not ("Climatologia" in tagTitulo or "Vento" in tagTitulo):
                    titulos[self.chavedoJson][tagTitulo] = link
        return titulos
    ...
    def pegarUrls(self):
        ...
        return self._titulacao(lista_urls)


'''
front = Frontend('Rio de Janeiro/RJ') ## Sao Paulo/SP
urls_novas = front.pegarUrls()
print(urls_novas)
'''